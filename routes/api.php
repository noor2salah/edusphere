...
//advertisements api's
    ...
    Route::get('show_class_subjects/{the_class}', [SubjectsController::class, 'show_class_subjects']);
    Route::get('show_subject/{id}', [SubjectsController::class, 'show_subject']);
    //test api's
    Route::post('storeTest', [TestController::class, 'store_test']);
    Route::get('ShowByClassLevel/{class_level}', [TestController::class, 'show_test_by_class_level']);
    Route::get('show', [TestController::class, 'index']);
    Route::post('store_grade_test', [TestController::class, 'store_grade_test']);
    Route::get('show_grade_test/{id}', [TestController::class, 'show_grade']);
    Route::get('show_grade_by_student/{id}', [TestController::class, 'show_grade_by_student']);
    Route::get('show_all_grade', [TestController::class, 'show_all_grades']);
    ...
    //teacher list Api's
    Route::get('show_7th_teachers', [TeachersListController::class, 'show_7th_teachers']);
    Route::get('show_8th_teachers', [TeachersListController::class, 'show_8th_teachers']);
    Route::get('show_9th_teachers', [TeachersListController::class, 'show_9th_teachers']);
